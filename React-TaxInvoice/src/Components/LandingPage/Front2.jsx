...
const BlogSection = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      {/* Section Title */}
      <h1 className="text-3xl font-bold mb-8">Lastest articles</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <div className="flex space-x-6">
            ...
            <div className="w-2/3">
              ...
              <p className="text-gray-500 mt-3">
              This means your software adapts to tax laws across different countries, making it easy for multinational businesses to manage invoices without worrying about varying tax regulations.</p>
              <div className="flex items-center mt-4 text-gray-500">
                <img
                  src="https://ik.imagekit.io/rxdxtxpigt/nib-removebg-preview.png?updatedAt=1727620962628"
                  alt="Sophie Moore"
          ...
          <div className="flex space-x-6">
            ...
            <div className="w-2/3">
              ...
              <p className="text-gray-500 mt-3">
              It could provide a library of customizable invoice templates, making it easy for businesses to create professional, branded invoices in seconds.                </p>
              <div className="flex items-center mt-4 text-gray-500">
                <img
                  src="https://ik.imagekit.io/rxdxtxpigt/nib-removebg-preview.png?updatedAt=1727620962628"
                  alt="Sophie Moore"
        ...
        <div className="space-y-12">
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold mb-4 text-gray-800">Contact Invoicely <i className="fas fa-pen-nib"></i></h3>
            <p className="text-gray-600 mb-6 leading-relaxed">
            We'd love to hear from you! If you have any questions, feedback, or inquiries about our tax invoice application, feel free to reach out.            </p>
            <div className="relative flex items-center">
              <input
                type="text"
                placeholder="Type your message"
                className="w-full p-4 pr-16 bg-white border border-gray-300 rounded-full focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all duration-200 ease-in-out hover:border-black"
              />
          ...
          <div className="relative w-full">
            ...
            <div className="absolute bottom-4 left-4 text-white">
              ...
              <h2 className="text-lg font-semibold mt-2">"Embrace the tax process—it’s a sign of your success and contribution to society!"</h2>
            </div>
          </div>
        </div>
      </div>
