...
const Front3 = () => {
  ...
  return (
    <div className="text-white min-h-screen flex flex-col items-center py-10 bg-black">
      <h1 className="text-3xl font-bold text-gray-500 mb-20">
